                ...
                <div>
                    <div className={`${StylesBoard.boardCards} ${StylesBoard.scroll}`}>
                        <div className={StylesBoard.boardCards_background}>
                            <br />
                            <div className={StylesBoard.columnHeader}>
                                <div className={StylesBoard.boardCards_backgroundTitle}>Bloglog</div>
                                <div className={StylesBoard.columnActions}>
                                    <img src='Assets/collaspe.svg' alt='collapse' onClick={() => setCollasped({ ...collasped, backlog: !collasped.backlog })} />
                                </div>
                            </div>
                        ...
                        <div className={StylesBoard.boardCards_background}>
                            <br />
                            <div className={StylesBoard.columnHeader}>
                                <div className={StylesBoard.boardCards_backgroundTitle}>Todo</div>
                                <div className={StylesBoard.columnActions}>
                                    <img src='Assets/add.svg' alt='add' onClick={onOpenModal} />
                                    <img
                        ...
                        <div className={StylesBoard.boardCards_background}>
                            <br />
                            <div className={StylesBoard.columnHeader}>
                                <div className={StylesBoard.boardCards_backgroundTitle}>Inprogress</div>
                                <div className={StylesBoard.columnActions}>
                                    <img src='Assets/collaspe.svg' alt='collapse' onClick={() => setCollasped({ ...collasped, inprogress: !collasped.inprogress })} />
                                </div>
                            </div>
                        ...
                        <div className={StylesBoard.boardCards_background}>
                            <br />
                            <div className={StylesBoard.columnHeader}>
                                <div className={StylesBoard.boardCards_backgroundTitle}>Done</div>
                                <div className={StylesBoard.columnActions}>
                                    <img src='Assets/collaspe.svg' alt='collapse' onClick={() => setCollasped({ ...collasped, done: !collasped.done })} />
                                </div>
                            </div>
