    ...
    return (
        <>
            <div className={StylesDashboard.dashboard}>
                {/* Sidebar Start */}
                <nav className={StylesDashboard.sideNavBar} aria-label="Primary navigation">
                    <div className={StylesDashboard.topRow}>
                        <div className={StylesDashboard.logo}>
                            <img src='Assets/logo.svg' alt='Pro Manage Logo' style={{ width: '21%' }} />Pro Manage
                        </div>
                        <button
                            className={StylesDashboard.mobileToggle}
                            onClick={toggleNav}
                    ...
                    <div className={`${StylesDashboard.navItems} ${!isNavOpen ? StylesDashboard.navItemsCollapsed : ''}`}>
                        ...
                        <div className={StylesDashboard.spacer} />
                        <div className={activeItem === 'Logout' ? StylesDashboard.activeItem : StylesDashboard.inactiveItem} onClick={onOpenModal}>
                            <img src='Assets/Logout.svg' alt='Logout' style={{ width: '21%' }} /><span style={{ color: '#cf3636' }}>Logout</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                    </div>
                </nav>
                {/* Sidebar End */}
                <main className={StylesDashboard.mainContent}>
                    {toggleMenu()}
                </main>
            </div>
